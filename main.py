...
@app.route('/')
def home():
    return "SENTINEL V12.4 (24 SAAT KORUMALI) AKTIF"
...
def botu_calistir():
    log_yaz("🛡️ SENTINEL (V12.4 - 24 Saat Korumalı) Başlatılıyor...")
                    ...
                    if client:
                        while not basari and deneme < 3:
                            try:
                                ...
                                time.sleep(3600) # Başarılıysa 1 saat bekle
                                break 

                            except tweepy.errors.TooManyRequests:
                                log_yaz("   ❌ 429 GÜNLÜK KOTA DOLDU! Bot 24 SAAT derin uykuya geçiyor...")
                                basari = True
                                time.sleep(86400) # 86400 Saniye = 24 Saat
                            except Exception as e:
                                deneme += 1
