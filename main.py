...
@app.route('/')
def home():
    return "SENTINEL V14.0 (7/24 AKTIF MOD) CALISIYOR"
...
def botu_calistir():
    log_yaz("🛡️ SENTINEL (V14.0 - 7/24 Aktif) Başlatılıyor...")
                    ...
                    if client:
                        while not basari and deneme < 3:
                            try:
                                ...
                                # 1 SAAT BEKLEME (EN ÖNEMLİ KISIM)
